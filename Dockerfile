...
ARG GIT_COMMIT=main-prisym
ENV GIT_COMMIT=$GIT_COMMIT
RUN npx next build --webpack

FROM node:24-alpine AS runner

LABEL org.opencontainers.image.title="Prisym Bulwark"
LABEL org.opencontainers.image.description="Modern webmail client built with Next.js and the JMAP protocol"
LABEL org.opencontainers.image.source="https://github.com/PrisymVC/bulwarkmail-webmail"
LABEL org.opencontainers.image.url="https://github.com/Prisym-VC/bulwarkmail-webmail"
